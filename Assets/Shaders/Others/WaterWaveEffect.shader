Shader "Others/WaterWave Effect" {
	Properties {
	...
	fixed4 frag(v2f_img i):SV_Target{
		...
		float sinFactor = sin(dis*_distanceFator+_Time.y*_timeFactor)*_timeFactor*0.01;
		//距离当前波纹运动，如果小于waveWidth才予以保留，否则已经出了波纹范围，factor通过clamp设置为0
